...
export function SearchComponent(): HTMLElement {
  ...
  //  använder Icons istället för inline svg
  leftIcon.innerHTML = Icons.search({ className: "h-5 w-5" });
  ...
  hint.className = "mx-auto m-3 max-w-3xl text-xs text-zinc-500";
  hint.textContent =
    "Tips: tryck Enter för att söka. Rensa för att se populära filmer igen.";
